# Lab 08-05 — Advanced Integration

**Module:** 08 — Jitsi video conferencing  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-08-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect jitsi to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 08-01 through 08-04 pass
